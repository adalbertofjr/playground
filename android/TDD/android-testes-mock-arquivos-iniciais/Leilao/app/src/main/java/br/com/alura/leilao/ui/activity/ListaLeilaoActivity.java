...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        atualizadorDeLeiloes.buscaLeiloes(adapter, client, new AtualizadorDeLeiloes.ErroAoCarregaLeilaoListener() {
            @Override
            public void erroAoCarregar(String mensagem) {
                apresentaMensagemDeErro(mensagem);
            }
        });
    }
    ...
    public void apresentaMensagemDeErro(String mensagem) {
        Toast.makeText(this,
