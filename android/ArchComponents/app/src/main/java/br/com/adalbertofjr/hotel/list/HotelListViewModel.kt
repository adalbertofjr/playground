...
import br.com.adalbertofjr.hotel.common.SingleLiveEvent
...
class HotelListViewModel(
    ...
    private val hotels =
        Transformations.switchMap(searchTerm) { term ->
            repository.search("%$term%")
        }
    private val inDeleteMode = MutableLiveData<Boolean>().apply { value = false }
